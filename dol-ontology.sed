...
/<!-- &dct;creator -->/,/<owl:AnnotationProperty rdf:about="&dct;creator"\/>/ d
/<!-- &dct;license -->/,/<owl:AnnotationProperty rdf:about="&dct;license"\/>/ d
/<!-- &sm;contentLanguage -->/,/<owl:AnnotationProperty rdf:about="&sm;contentLanguage"\/>/ d
/<!-- &sm;copyright -->/,/<owl:AnnotationProperty rdf:about="&sm;copyright"\/>/ d
/<!-- &sm;fileAbstract -->/,/<owl:AnnotationProperty rdf:about="&sm;fileAbstract"\/>/ d
/<!-- &sm;filename -->/,/<owl:AnnotationProperty rdf:about="&sm;filename"\/>/ d
/<!-- &sm;isNormative -->/,/<owl:AnnotationProperty rdf:about="&sm;isNormative"\/>/ d
/<!-- &sm;license -->/,/<owl:AnnotationProperty rdf:about="&sm;license"\/>/ d
